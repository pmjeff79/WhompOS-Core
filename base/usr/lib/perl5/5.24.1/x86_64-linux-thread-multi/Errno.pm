...
"x86_64-linux-thread-multi-4.10.0-21-generic" or
	die "Errno architecture (x86_64-linux-thread-multi-4.10.0-21-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
